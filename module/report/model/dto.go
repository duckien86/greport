...
type MsgLogFilter struct {
	...
	CampaignId string   `json:"campaign_id" validate:"omitempty,alphanum" form:"campaign_id"`
	...
	PoIds      []string `json:"po_ids" validate:"omitempty,dive,alphanum" form:"po_ids"`
	AppNames   []string `json:"app_names" validate:"omitempty,dive,alphanum" form:"app_names"`
}
...
type MsgLogResponse struct {
	...
	ClientCampaignId string          `json:"client_campaign_id"`
